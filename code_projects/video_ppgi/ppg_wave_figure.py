...
def wave_figure(bvp_signal, ppg_signal, fs, timestamps):
    ...
    plt.plot(timestamps, ppg_normalized, color='blue', label='Ground Truth')
    plt.plot(timestamps, bvp_normalized, color='orange', label='Extracted PPG')
